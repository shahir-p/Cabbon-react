        ...
        <>
            <div className='home d-flex flex-column ' style={{ width: `${width}px`, height: `${height}px`, }}>
                <div className='today ' style={{
                    height: `${height * 0.2}px`, margin: "10px", marginTop: `${height * 0.1 + 10}px`, borderRadius: "10px", border: "1px solid", padding: "10px",backgroundImage: `url(${todaybg})`,backgroundSize: 'cover',backgroundRepeat: 'no-repeat',
                }}>
                ...
                <div className='Payment ' style={{ height: `${height * 0.2}px`, margin: "10px", marginTop: "10px", borderRadius: "10px", border: "1px solid", padding: "10px" ,backgroundImage: `url(${paymentbg})`,backgroundSize: 'cover',backgroundRepeat: 'no-repeat',}}>
