...
const BcPaymentDetails = ({ height, width }) => {
    ...
    return (
        <>
            <div className='' style={{ height: `${height}px`, width: `${width}`, marginTop: `${height * 0.1}px`, padding: "10px 20px" }}>
            <div className='d-flex mb-3 mt-2'>
                ...
                <div className='list d-flex flex-column justify-content-between align-items-center mb-2 ' style={{ height: `${height * 0.2}px`, width: `${width - 40}px`, border: "1px solid", borderRadius: "10px", fontSize: "15px", padding: "0px 20px", backgroundImage: `url(https://i.postimg.cc/1t4ZkrKm/pendingbg.png)`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: "center" }} onClick={handleShow} >
